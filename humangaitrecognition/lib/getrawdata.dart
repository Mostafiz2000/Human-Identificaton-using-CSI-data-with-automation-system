...
class getudata extends StatefulWidget {
  const getudata({super.key});

  @override
  State<getudata> createState() => _getudataState();
}
...
class _getudataState extends State<getudata> {
  bool isLoading = true;
  @override
                              ...
                              onPressed: () {
                                setState(() {
                                  if (isLoading == false)
                                    ...
                                    isLoading = false;
                                  if (isLoading == false) {
                                    statusdata2(4, myController.text);
                                  } else {
                                    statusdata2(5, myController.text);
                                  }
                                });
                              },
                              child: isLoading
